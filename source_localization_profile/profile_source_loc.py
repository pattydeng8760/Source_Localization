...
here = os.path.dirname(os.path.abspath(__file__))          # .../Source_Localization/source_localization_profile
proj_root = os.path.dirname(here)                          # .../Source_Localization
core_dir = os.path.join(proj_root, "source_localization_core")
sys.path.append(core_dir)

import source_localization_core_cpp  # compiled extension only, no Antares
